...
final class AdsCollectionFooterView: DPCollectionSupplementaryView {
...
extension AdsCollectionFooterView {
    
    typealias Adapter = DPCollectionSupplementaryAdapter<AdsCollectionFooterView, Model>
