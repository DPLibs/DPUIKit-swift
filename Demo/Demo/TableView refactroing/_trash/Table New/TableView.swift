...
//    @available(iOS 13.0, *)
//    open func scrollToRow<R: TableViewCellAdapterProtocol & Identifiable>(_ row: R, at scrollPosition: UITableView.ScrollPosition, animated: Bool) {
...
//        _ rows: [TableViewCellAdapterProtocol],
...
//
//    @available(iOS 13.0, *)
//    static func setRows<R: TableViewCellAdapterProtocol & Identifiable>(
//        _ rows: [R],
//        with rowAnimation: UITableView.RowAnimation
//    ) -> TableView.Update {
//        TableView.Update { tableView in
...
//
//    @available(iOS 13.0, *)
//    static func deleteRows<R: TableViewCellAdapterProtocol & Identifiable>(
//        _ rows: [R],
//        with rowAnimation: UITableView.RowAnimation
//    ) -> TableView.Update {
//        TableView.Update { tableView in
